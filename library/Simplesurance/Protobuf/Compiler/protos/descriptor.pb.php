...
namespace google\protobuf {
  ...
  class OneofDescriptorProto extends \Simplesurance\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \Simplesurance\Protobuf\Descriptor(__CLASS__, 'google.protobuf.OneofDescriptorProto');
