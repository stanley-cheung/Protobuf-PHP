...
class PhpGenerator extends AbstractGenerator
{
    ...
    protected function compileEnum(proto\EnumDescriptorProto $enum, $ns)
    {
        ...
        $s[]= "  class " . $enum->getName() . ' extends \Simplesurance\Protobuf\Enum {';
    ...
    protected function compileMessage(proto\DescriptorProto $msg, $ns)
    {
        ...
        $s[]= 'class ' . $msg->getName() . ' extends \Simplesurance\Protobuf\Message {';
        $s[]= '';
        ...
        $s[]= '    {';
        $s[]= '        $descriptor = new \Simplesurance\Protobuf\Descriptor(__CLASS__, \'' . $ns . '\');';
        $s[]= '';
    ...
    protected function compileField(proto\FieldDescriptorProto $field, $ns, $indent)
    {
        ...
        $refl = new \ReflectionClass('\Simplesurance\Protobuf');
        ...
        $s[]= '$f = new \Simplesurance\Protobuf\Field();';
        $s[]= '$f->number    = ' . $field->getNumber() . ';';
        $s[]= '$f->name      = "'. $field->getName() . '";';
        $s[]= '$f->type      = \Simplesurance\Protobuf::TYPE_' . $type . ';';
        $s[]= '$f->rule      = \Simplesurance\Protobuf::RULE_' . $rule . ';';
