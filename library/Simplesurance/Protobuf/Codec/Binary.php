...
class Binary implements Protobuf\CodecInterface
{
    ...
    /**
     * @param \Simplesurance\Protobuf\Codec\Binary\Reader $reader
     * @param \Simplesurance\Protobuf\Message             $message
     * @param int                                   $length 
     * @return \Simplesurance\Protobuf\Message
     */
    protected function decodeMessage($reader, \Simplesurance\Protobuf\Message $message, $length = NULL)
    {
        /** @var $message \Simplesurance\Protobuf\Message */
        /** @var $descriptor \Simplesurance\Protobuf\Descriptor */
